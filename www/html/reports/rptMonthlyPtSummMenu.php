...
require_once dirname(__FILE__).'/uitext/rptMonthlyPtSummMenuText.php';
...
$thisReport['linkText'] = TEXT_REPORT_LINK_TEXT_MONTHLY_PATIENT_BY_DAY_LOG; // the text to display as the link to the report
$thisReport['linkURI'] = TEXT_REPORT_LINK_URI_MONTHLY_PATIENT_BY_DAY_LOG; // the relative URI of the report home (if different than the default)
$thisReport['linkTitle'] = TEXT_REPORT_LINK_TITLE_MONTHLY_PATIENT_BY_DAY_LOG; // the link's hovertext
$thisReport['linkDesc'] = TEXT_REPORT_LINK_DESC_MONTHLY_PATIENT_BY_DAY_LOG; // the longer description text to follow the link
